...
<html>
  ...
  <body>
          ...
          <nav class="js-mega-menu navbar navbar-toggleable-md">
            <div class="container">
              ...
              <a href="index.html" class="navbar-brand">
                <img src="resources/WB0412697/html/assets/img/logo/logo-1.png" alt="Image Description">
              </a>
              <!-- End Logo -->
      ...
      <section class="dzsparallaxer auto-init height-is-based-on-content use-loading g-min-height-100vh" data-options='{direction: "reverse", settings_mode_oneelement_max_offset: "150"}'>
        <div class="divimage dzsparallaxer--target w-100 g-bg-cover g-bg-img-hero g-bg-bluegray-gradient-opacity-v3--after" style="height: 130%; background-image: url(resources/WB0412697/html/assets/img-temp/1920x1080/img48.jpg);"></div>
      ...
      <section class="container-fluid g-px-50 g-pt-70 g-pt-170--md g-pb-70">
        <div class="row justify-content-start align-items-center g-mx-minus-25">
          ...
          <div class="col-lg-6 flex-lg-first g-px-25 g-mb-30">
            <img class="img-fluid" src="resources/WB0412697/html/assets/img-temp/1500x1040/img1.png" alt="Image Description">
          </div>
        </div>
      </section>
        ...
        <div class="row g-mx-minus-25">
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            ...
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img100.jpg" alt="Image Description">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img1.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img2.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img3.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img4.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img5.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img6.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img7.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img8.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img9.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img10.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img11.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img12.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img13.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img14.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img15.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img51.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img52.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img53.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img54.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
      ...
      <section class="container-fluid g-px-50 g-pt-100 g-pb-70">
        <div class="row justify-content-start align-items-center g-mx-minus-25">
          ...
          <div class="col-md-6 g-px-25 g-mb-30">
            <img class="img-fluid" src="resources/WB0412697/html/assets/img-temp/1500x1040/img2.png" alt="Image Description">
          </div>
        </div>
      </section>
      ...
      <section id="onepages" class="container-fluid g-bg-secondary g-px-50 g-py-100">
        ...
        <div class="row g-mx-minus-25">
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img23.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img22.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img16.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img17.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img18.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img19.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img20.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img21.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img26.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img27.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img28.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img29.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img30.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img31.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img32.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img33.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img34.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img35.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img36.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img37.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img38.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
      ...
      <section class="container-fluid g-px-50 g-pt-100 g-pb-70">
        <div class="row justify-content-start align-items-center g-mx-minus-25">
          ...
          <div class="col-md-6 flex-md-first g-px-25 g-mb-30">
            <img class="img-fluid" src="resources/WB0412697/html/assets/img-temp/1500x1040/img3.png" alt="Image Description">
          </div>
        </div>
      </section>
      ...
      <section id="ecommerce" class="container-fluid g-bg-secondary g-px-50 g-py-100">
        ...
        <div class="row g-mx-minus-25">
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img41.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img42.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img43.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img44.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img45.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img46.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img47.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
      ...
      <section class="container-fluid g-px-50 g-pt-100 g-pb-70">
        <div class="row justify-content-start align-items-center g-mx-minus-25">
          ...
          <div class="col-md-6 g-px-25 g-mb-30">
            <img class="img-fluid" src="resources/WB0412697/html/assets/img-temp/1500x1040/img4.png" alt="Image Description">
          </div>
        </div>
      </section>
      ...
      <section id="blogmagazine" class="container-fluid g-bg-secondary g-px-30 g-py-100">
        ...
        <div class="row justify-content-center">
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img39.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img40.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
      ...
      <section class="container-fluid g-px-50 g-pt-100 g-pb-70">
        <div class="row justify-content-start align-items-center g-mx-minus-25">
          ...
          <div class="col-md-6 flex-md-first g-px-25 g-mb-30">
            <img class="img-fluid" src="resources/WB0412697/html/assets/img-temp/1500x1040/img5.png" alt="Image Description">
          </div>
        </div>
      </section>
      <!-- End Master Slider -->
      ...
      <section id="specialty" class="container-fluid g-bg-secondary g-px-50 g-py-100">
        ...
        <div class="row justify-content-center">
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img48.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img49.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img50.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
      ...
      <section id="endlesspages" class="container-fluid g-px-50 g-py-100">
        ...
        <div id="carousel1" class="js-carousel g-mx-minus-25"
          ...
          <div class="js-slide g-px-25">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img55.jpg" data-lazy="resources/WB0412697/html/assets/img-temp/600x295/img55.jpg" alt="Image description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="js-slide g-px-25">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img56.jpg" data-lazy="resources/WB0412697/html/assets/img-temp/600x295/img56.jpg" alt="Image description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="js-slide g-px-25">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img57.jpg" data-lazy="resources/WB0412697/html/assets/img-temp/600x295/img57.jpg" alt="Image description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="js-slide g-px-25">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img58.jpg" data-lazy="resources/WB0412697/html/assets/img-temp/600x295/img58.jpg" alt="Image description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="js-slide g-px-25">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img59.jpg" data-lazy="resources/WB0412697/html/assets/img-temp/600x295/img59.jpg" alt="Image description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="js-slide g-px-25">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img60.jpg" data-lazy="resources/WB0412697/html/assets/img-temp/600x295/img60.jpg" alt="Image description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="js-slide g-px-25">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img61.jpg" data-lazy="resources/WB0412697/html/assets/img-temp/600x295/img61.jpg" alt="Image description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="js-slide g-px-25">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img62.jpg" data-lazy="resources/WB0412697/html/assets/img-temp/600x295/img62.jpg" alt="Image description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="js-slide g-px-25">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img63.jpg" data-lazy="resources/WB0412697/html/assets/img-temp/600x295/img63.jpg" alt="Image description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="js-slide g-px-25">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img64.jpg" data-lazy="resources/WB0412697/html/assets/img-temp/600x295/img64.jpg" alt="Image description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="js-slide g-px-25">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img65.jpg" data-lazy="resources/WB0412697/html/assets/img-temp/600x295/img65.jpg" alt="Image description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="js-slide g-px-25">
            <!-- Pages -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img66.jpg" data-lazy="resources/WB0412697/html/assets/img-temp/600x295/img66.jpg" alt="Image description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
      ...
      <section id="promoblocks" class="container-fluid g-bg-secondary g-px-50 g-py-100">
        ...
        <div class="row g-mx-minus-25">
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img66.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img67.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img68.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img69.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img70.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img71.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img73.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img74.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img75.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img76.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img77.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img78.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img79.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img80.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img81.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img82.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img83.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img84.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img85.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img86.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img87.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img88.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img89.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img90.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img91.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img92.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img93.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img94.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img95.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img96.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img97.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img98.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
          ...
          <div class="col-sm-6 col-lg-3 g-px-25 g-mb-70">
            <!-- Promo Blocks -->
            <div class="text-center u-block-hover">
              <img class="img-fluid u-shadow-v21 rounded g-mb-30" src="resources/WB0412697/html/assets/img-temp/600x295/img99.jpg" alt="Image Description">
              <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
      ...
      <div class="dzsparallaxer auto-init height-is-based-on-content use-loading g-bg-cover g-bg-bluegray-gradient-opacity-v3--after">
        <div class="divimage dzsparallaxer--target w-100 u-bg-overlay g-bg-white-gradient-opacity-v2--after" style="height: 160%; background: url(resources/WB0412697/html/assets/img-temp/720x299/img1.jpg);"></div>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img1.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img2.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img3.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img4.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img5.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img6.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img7.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img8.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img9.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img10.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img11.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img12.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img13.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img14.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img15.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img16.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img17.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img18.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img19.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img20.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img21.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img22.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img23.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img24.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img25.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img26.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img27.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img28.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
            ...
            <div class="col-6 col-md-3 g-mb-70">
              <div class="text-center u-block-hover">
                <img class="img-fluid g-mb-30" src="resources/WB0412697/html/assets/img-temp/500x350/img29.png" alt="Image Description">
                <h3 class="h6 g-color-black g-font-weight-600 g-font-size-13 text-uppercase">
      ...
      <section class="container g-py-100">
        ...
        <img class="img-fluid g-mb-70" src="resources/WB0412697/html/assets/img-temp/1445x750/img1.png" alt="Image Description">
      ...
      <div class="text-center g-bg-size-cover g-bg-cover g-bg-bluegray-gradient-opacity-v3--after g-py-100" style="background-position: center -150px; background-image: url(resources/WB0412697/html/assets/img-temp/1920x800/img23.jpg);">
      ...
      <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-pos-rel g-overflow-hidden" data-options='{direction: "reverse", settings_mode_oneelement_max_offset: "150"}'>
        <div class="divimage dzsparallaxer--target w-100" style="height: 110%; background-image: url(resources/WB0412697/html/assets/img-temp/1920x800/img27.jpg);"></div>
        ...
        <div class="g-pos-abs g-bottom-minus-20 g-bottom-minus-50--md g-left-0"
          ...
          <img class="img-fluid" src="resources/WB0412697/html/assets/img-temp/1920x800/img24.png" alt="Image description">
        </div>
        <div class="g-pos-abs g-bottom-minus-20 g-bottom-minus-50--md g-right-0"
          ...
          <img class="img-fluid" src="resources/WB0412697/html/assets/img-temp/1920x800/img25.png" alt="Image description">
        </div>
        <div class="g-pos-abs g-bottom-minus-20 g-bottom-minus-50--md g-right-0"
             data-parallaxanimation='[{property: "transform", value:" translate3d(0,{{val}}px,0)", initial:"-70", mid:"0", final:"70"}]'>
          <img class="img-fluid" src="resources/WB0412697/html/assets/img-temp/1920x800/img26.png" alt="Image description">
        </div>
        ...
        <div class="row justify-content-between">
          <div class="col-lg-3 g-mb-30">
            <a class="d-inline-block mb-4" href="unify-main/home/home-page-1.html">
              <img class="g-width-100 g-height-auto" src="resources/WB0412697/html/assets/img/logo/logo-1.png" alt="Image Description">
            </a>
    ...
    <script src="resources/WB0412697/html/assets/vendor/jquery.easing/js/jquery.easing.js"></script>
    ...
    <script src="resources/WB0412697/html/assets/vendor/masonry/dist/masonry.pkgd.min.js"></script>
    ...
    <script src="resources/WB0412697/html/assets/js/components/hs.scroll-nav.js"></script>
    <script src="resources/WB0412697/html/assets/js/components/hs.go-to.js"></script>
    <script src="resources/WB0412697/html/assets/js/components/hs.sticky-block.js"></script>
    <script src="resources/WB0412697/html/assets/js/helpers/hs.height-calc.js"></script>
